        ...
        <div class="col-12">
            <div class="card bg-white">
                <div class="card-header">
                    <h4 class="card-title text-dark">Product Detail Information</h4>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3 ">
                        ...
                        <select class="form-control pnt-modal-sel-add-product-location">
                        </select>
                    </div>

                    <div class="form-group">
                        <label class="mb-1"><strong>Serial</strong></label>
                        <input type="text" class="form-control pnt-modal-add-detail-code"
                               placeholder="Name" required>
                    </div>

                    <div class="form-group">
                        <label class="mb-1"><strong>Latitude</strong></label>
                        <input type="text" class="form-control pnt-modal-add-detail-latitude">
                    </div>

                    <div class="form-group">
                        <label class="mb-1"><strong>Latitude</strong></label>
                        <input type="text" class="form-control pnt-modal-add-detail-longitude">
                    </div>

                    <div class="form-group">
                        <label class="mb-1"><strong>Sku</strong></label>
                        <input type="text" class="form-control pnt-modal-add-detail-sku">
                    </div>
...
@section('script')
    ...
    <script>
        ...
        $(document).off('click', '.pnt-btn-modal-add-detail-save').on('click', '.pnt-btn-modal-add-detail-save', e => {
            ...
            var location_id = $(".pnt-modal-sel-add-product-location option:selected").val();
            ...
            if (product_id == 0) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        code: $('.pnt-modal-add-detail-code').val(),
                        location_id: location_id,

                        latitude: $('.pnt-modal-add-detail-latitude').val(),
                        longitude: $('.pnt-modal-add-detail-longitude').val(),
                        status: 0,
                        sku: $('.pnt-modal-add-detail-sku').val(),
                        '_token': window.token,
                    },
                    success: function (data) {
                        if (data.status) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status) {
                        ...
                        $(".pnt-modal-sel-edit-product-location").val(data.product.location_id).change();
