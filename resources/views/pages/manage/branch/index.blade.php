        ...
        <div class="col-12">
            <div class="card bg-white">
                <div class="card-header">
                    ...
                    <button type="button" class="btn btn-info pnt-bnt-add-branch">Add <span class="btn-icon-right"><i class="fa fa-plus color-info"></i></span>
                    </button>
                </div>
                <div class="card-body">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control pnt-modal-add-branch-name" id="name" name="name" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control pnt-modal-add-address" id="address" name="address" value="" required>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="mb-1"><strong>Branch Name</strong></label>
                        <input type="text" class="form-control pnt-modal-edit-branch-name" id="name" name="name" required>
                    </div>
                    <div class="form-group">
                        <label class="mb-1"><strong>Phone Number</strong></label>
                    ...
                    <div class="form-group">
                        <label class="mb-1"><strong>Address</strong></label>
                        <input type="text" class="form-control pnt-modal-edit-branch-address" id="address" name="address" value="" required>
                    </div>
