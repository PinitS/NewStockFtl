            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control pnt-modal-add-location-name" id="name" name="name" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control pnt-modal-add-location-latitude" id="latitude" name="latitude" value="" >
                    </div>

                    <div class="form-group">
                        <label class="mb-1"><strong>Longitude</strong></label>
                        <input type="text" class="form-control pnt-modal-add-location-longitude" id="longitude" name="longitude" value="" >
                    </div>

                    <div class="form-group">
                        <label class="mb-1"><strong>Address</strong></label>
                        <input type="text" class="form-control pnt-modal-add-location-address" id="address" name="address" value="" required>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control pnt-modal-edit-location-name" id="name" name="name" required>
                    </div>
                    <div class="form-group">
                        <label class="mb-1"><strong>Phone Number</strong></label>
                    ...
                    <div class="form-group">
                        <label class="mb-1"><strong>Latitude</strong></label>
                        <input type="text" class="form-control pnt-modal-edit-location-latitude" id="latitude" name="latitude" value="" >
                    </div>

                    <div class="form-group">
                        <label class="mb-1"><strong>Longitude</strong></label>
                        <input type="text" class="form-control pnt-modal-edit-location-longitude" id="longitude" name="longitude" value="" >
                    </div>

                    <div class="form-group">
                        <label class="mb-1"><strong>Address</strong></label>
                        <input type="text" class="form-control pnt-modal-edit-location-address" id="address" name="address" value="" required>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        $(document).off('click', '.pnt-btn-modal-add-location-save').on('click', '.pnt-btn-modal-add-location-save', e => {
            $.ajax({
                ...
                data: {
                    ...
                    latitude : $('.pnt-modal-add-location-latitude').val(),
                    longitude : $('.pnt-modal-add-location-longitude').val(),
        ...
        $(document).off('click', '.pnt-btn-delete').on('click', '.pnt-btn-delete', (e) => {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "get",
                        url: "{!! url('manage/product_location/location/destroy') !!}/"+window.id,
                        success: function (data) {
                            resetTable();
        ...
        $(document).off('click', '.pnt-btn-edit').on('click', '.pnt-btn-edit', (e) => {
            ...
            $.ajax({
                type: "get",
                url: "{!! url('manage/product_location/location/getOneLocation') !!}/"+window.id,
                success: function (data) {
                    console.log(data);
                    if(data.status)
                    {
                        ...
                        $(".pnt-modal-edit-location-latitude").val(data.location.latitude);
                        $(".pnt-modal-edit-location-longitude").val(data.location.longitude);
        ...
        $(document).off('click', '.pnt-btn-modal-save-location').on('click', '.pnt-btn-modal-save-location', e => {
            $.ajax({
                type: "post",
                url: "{!! url('manage/product_location/location/update') !!}/"+window.id,
                data: {
                    name : $('.pnt-modal-edit-location-name').val(),
                    phone_number : $('.pnt-modal-edit-location-phone').val(),
                    latitude : $('.pnt-modal-edit-location-latitude').val(),
                    longitude : $('.pnt-modal-edit-location-longitude').val(),
